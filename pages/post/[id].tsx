        ...
        <>
            ...
            >
                ...
                <Grid container sx={{ maxWidth: 'md' }}>
                    ...
                    >
                        {/* stack */}
                        <Stack spacing={2} minWidth={{ xs: 370, sm: 600 }} >
                            {/* content */}
                            ...
                            <Box sx={{ padding: { xs: 2, sm: 4 }, borderRadius: 1, boxShadow: { xs: 0, sm: 1 } }}>
                                {/* member info */}
                                <Stack direction={'row'}>
                                    <Avatar sx={{ bgcolor: 'grey' }}>{'W'}</Avatar>
                                    <Box ml={1}>
                                        <Typography variant='body2'>
                                            WebMaster
                                        </Typography>
                                ...
                                <Box sx={{ paddingTop: 1, paddingX: 1 / 2 }}>
                                    <Typography variant={'body2'} fontSize={{ sm: 16 }}>{'随风天气提供全球实况格点天气和个性化场景天气，根据天气影响比较多的行业、职业、风土人情等结合出来的方式（上班族，钓鱼，旅游旅行等）。'}</Typography>
                                </Box>
                                {/* member behaviours */}
                                <Grid container>
                                    {/* like */}
                                ...
                                {/* subcomment stack */}
                                <Stack paddingLeft={3} marginTop={{ xs: 1, sm: 2 }}>
                                    {/* subcomment */}
                                    <Box>
                                        {/* member info */}
                                        <Stack direction={'row'}>
                            ...
                            {/* comment */}
                            <Box sx={{ padding: 1, borderRadius: 1, boxShadow: { xs: 0, sm: 1 } }}>
                                comment
                            </Box>
