...
const langConfigs: LangConfigs = {
    ...
    terms: {
        tw: [
            ...
            '請您遵守以上聲明，使用本軟件前請仔細閱讀。',
        ],
        cn: [
            '1. 版权声明：本软体受著作权法和国际版权公约的保护。未经我们书面许可，您不得以任何方式复制、使用或散布本软体',
            '2. 服务声明：我们将按照您在使用本软体时的需求提供服务，但我们不对因系统故障、网路故障等因素导致的服务中断和数据丢失负责。',
            '3. 隐私声明：我们将严格保护您的个人信息，不会将您的个人信息与任何第三方共享，除非得到您的同意或法律法规要求。',
            '4. 免责声明：我们不对因使用本软体造成的任何直接、间接、偶然、特殊或后果性损害负责，也不对因您的使用行为造成的任何损失负责。',
            '5. 更新声明：我们有权在不事先通知您的情况下对本软体进行更新，并不对因更新造成的任何影响负责。',
            '请遵守以上声明，使用本软件前请仔细阅读。'
        ],
        en: [
