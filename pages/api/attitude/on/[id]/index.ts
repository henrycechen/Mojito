        ...
        if ('POST' === method) {
            ...
            if (attitude !== prevAttitude && 1 === prevAttitude) {
                ...
                if (!memberStatisticsUpdateResult.acknowledged) {
                    logWithDate(`Failed to update totalUndoLikedCount (of IMemberStatistics, member id: ${memberId}) in [C] memberStatistics`, fnn);
                }
                if (['comment', 'subcomment'].includes(category)) {
                    ...
                    if (!commentAuthorStatisticsUpdateResult.acknowledged) {
                        logWithDate(`Failed to update totalCommentUndoLikedCount (of IMemberStatistics, member id: ${notifiedMemberId}) in [C] memberStatistics`, fnn);
                    }
                    ...
                    if (!commentComprehensiveUpdateResult.acknowledged) {
                        logWithDate(`Failed to update totalUndoLikedCount (of ICommetComprehensive, comment id: ${id}) in [C] commentComprehensive`, fnn);
                    }
                }
                if ('post' === category) {
                    ...
                    if (!postAuthorStatisticsUpdateResult.acknowledged) {
                        logWithDate(`Failed to update totalCreationUndoLikedCount (of IMemberStatistics, member id: ${notifiedMemberId}) in [C] memberStatistics`, fnn);
                    }
                    ...
                    if (!postComprehensiveUpdateResult.acknowledged) {
                        logWithDate(`Failed to update totalUndoLikedCount (of IPostComprehensive, post id: ${postId}) in [C] postComprehensive`, fnn);
                    }
                    ...
                    if (!channelStatisticsUpdateResult.acknowledged) {
                        logWithDate(`Failed to update totalUndoLikedCount (of IChannelStatistics, channel id: ${channelId}) in [C] channelStatistics`, fnn);
                    }
                    ...
                    if (Array.isArray(topicInfoArr) && topicInfoArr.length !== 0) {
                        ...
                        for await (const topicId of topicInfoArr) {
                            ...
                            if (!topicComprehensiveUpdateResult.acknowledged) {
                                logWithDate(`Failed to update totalUndoLikedCount (of ITopicComprehensive, topic id: ${topicId}) in [C] topicComprehensive`, fnn);
                            }
                        }
                    }
                }
            ...
            if (attitude !== prevAttitude && -1 === prevAttitude) {
                ...
                if (!memberStatisticsUpdateResult.acknowledged) {
                    logWithDate(`Failed to update total totalUndoDislikedCount (of IMemberStatistics, member id: ${memberId}) in [C] memberStatistics`, fnn);
                }
                if (['comment', 'subcomment'].includes(category)) {
                    ...
                    if (!commentAuthorStatisticsUpdateResult.acknowledged) {
                        logWithDate(`Failed to update totalCommentUndoDislikedCount (of IMemberStatistics, member id: ${notifiedMemberId}) in [C] memberStatistics`, fnn);
                    }
                    ...
                    if (!commentComprehensiveUpdateResult.acknowledged) {
                        logWithDate(`Failed to update totalUndoDislikedCount (of ICommetComprehensive, comment id: ${id}) in [C] commentComprehensive`, fnn);
                    }
                }
                if ('post' === category) {
                    ...
                    if (!postAuthorStatisticsUpdateResult.acknowledged) {
                        logWithDate(`Failed to update totalCreationUndoDislikedCount (of IMemberStatistics, member id: ${notifiedMemberId}) in [C] memberStatistics`, fnn);
                    }
                    ...
                    if (!commentComprehensiveUpdateResult.acknowledged) {
                        logWithDate(`Failed to update totalUndoDislikedCount (of IPostComprehensive, post id: ${postId}) in [C] postComprehensive`, fnn);
                    }
                }
            }
            ...
            if (attitude !== prevAttitude && 1 === attitude) {
                ...
                if (!memberStatisticsUpdateResult.acknowledged) {
                    logWithDate(`Failed to update total totalLikedCount (of IMemberStatistics, member id: ${memberId}) in [C] memberStatistics`, fnn);
                }
                if (['comment', 'subcomment'].includes(category)) {
                    ...
                    if (!commentAuthorStatisticsUpdateResult.acknowledged) {
                        logWithDate(`Failed to update total totalCommentLikedCount (of IMemberStatistics, member id: ${notifiedMemberId}) in [C] memberStatistics`, fnn);
                    }
                    ...
                    if (!commentComprehensiveUpdateResult.acknowledged) {
                        logWithDate(`Failed to update totalLikedCount (of ICommetComprehensive in [C] commentComprehensive`, fnn);
                    }
                }
                if ('post' === category) {
                    ...
                    if (!commentAuthorStatisticsUpdateResult.acknowledged) {
                        logWithDate(`Failed to update total totalCreationLikedCount (of IMemberStatistics, member id: ${notifiedMemberId}) in [C] memberStatistics`, fnn);
                    }
                    ...
                    if (!postComprehensiveUpdateResult.acknowledged) {
                        logWithDate(`Failed to update totalLikedCount (of IPostComprehensive, post id: ${postId}) in [C] postComprehensive`, fnn);
                    }
                    ...
                    if (!channelStatisticsUpdateResult.acknowledged) {
                        logWithDate(`Failed to update totalLikedCount (of IChannelStatistics, channel id: ${channelId}) in [C] channelStatistics`, fnn);
                    }
                    ...
                    if (Array.isArray(topicInfoArr) && topicInfoArr.length !== 0) {
                        ...
                        for await (const topicId of topicInfoArr) {
                            ...
                            if (!topicComprehensiveUpdateResult.acknowledged) {
                                logWithDate(`Failed to update totalLikedCount (of ITopicComprehensive, topic id: ${topicId}) in [C] topicComprehensive`, fnn);
                            }
                        }
                    }
                }
                if (memberId !== notifiedMemberId) {
                    ...
                    if (!blockingMemberMappingQueryResult.value) {
                        ...
                        if (!notificationStatisticsUpdateResult.acknowledged) {
                            logWithDate(`Failed to update like (of INotificationStatistics, member id: ${notifiedMemberId}) in [C] notificationStatistics`, fnn);
                        }
                    }
                }
            }
            ...
            if (attitude !== prevAttitude && -1 === attitude) {
                ...
                if (!memberStatisticsUpdateResult.acknowledged) {
                    logWithDate(`Failed to update totalDislikedCount (of IMemberStatistics, member id: ${memberId}) in [C] memberStatistics`, fnn);
                }
                if (['comment', 'subcomment'].includes(category)) {
                    ...
                    if (!commentAuthorStatisticsUpdateResult.acknowledged) {
                        logWithDate(`Failed to update totalCommentDislikedCount (of IMemberStatistics, member id: ${notifiedMemberId}) in [C] memberStatistics`, fnn);
                    }
                    ...
                    if (!commentComprehensiveUpdateResult.acknowledged) {
                        logWithDate(`Failed to update totalDislikedCount (of ICommetComprehensive, comment id: ${id}) in [C] commentComprehensive`, fnn);
                    }
                }
                if ('post' === category) {
                    ...
                    if (!postAuthorStatisticsUpdateResult.acknowledged) {
                        logWithDate(`Failed to update totalCreationDislikedCount (of IMemberStatistics, member id: ${notifiedMemberId}) in [C] memberStatistics`, fnn);
                    }
                    ...
                    if (!commentComprehensiveUpdateResult.acknowledged) {
                        logWithDate(`Failed to update totalDislikedCount (of IPostComprehensive, post id: ${postId}) in [C] postComprehensive`, fnn);
                    }
                }
            }
            await atlasDbClient.close();
