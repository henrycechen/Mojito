 ...
 * - statistics (of chosen category) (e.g., { 'cue': 99 })
 * 
...
export default async function ResetNotificationStatisticsByCategory(req: NextApiRequest, res: NextApiResponse) {
    ...
    //         throw new Error(`Member attempt to getting notice statistics but have no document (of IMemberComprehensive, member id: ${memberId}) in [C] memberComprehensive`);
    //     }
