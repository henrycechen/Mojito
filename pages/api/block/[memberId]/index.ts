...
export default async function BlockOrUndoBlockMemberById(req: NextApiRequest, res: NextApiResponse) {
    ...
    try {
        ...
        if (null === memberComprehensiveQueryResult) {
            throw new Error(`Member was trying blocking or undo blocking on a member but have no document (of IMemberComprehensive, member id: ${memberId}) in [C] memberComprehensive`);
        }
